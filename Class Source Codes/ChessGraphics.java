...
public class ChessGraphics
{
	...
	c.setColor (Color.white); //C
	c.fillRect (6 + 23 + i * 40, 23 + 383 - j * 40, 28, 1); //Bar 1
	c.fillRect (10 + 23 + i * 40, 22 + 383 - j * 40, 20, 1); //Bar 2
	c.setColor (Color.black);
	...
	c.setColor (Color.black); //C
	c.fillRect (8 + 23 + i * 40, 27 + 383 - j * 40, 24, 1); //Bar 3
	c.fillRect (9 + 23 + i * 40, 28 + 383 - j * 40, 22, 2); //Bar 4
	c.setColor (Color.black);
	c.fillRect (9 + 23 + i * 40, 29 + 383 - j * 40, 2, 1);
	c.fillRect (29 + 23 + i * 40, 29 + 383 - j * 40, 2, 1);
	c.setColor (Color.black); //C
	c.fillRect (9 + 23 + i * 40, 30 + 383 - j * 40, 22, 1); //Bar 5
	c.fillRect (9 + 23 + i * 40, 31 + 383 - j * 40, 22, 1); //Bar 6
	c.setColor (Color.black);
